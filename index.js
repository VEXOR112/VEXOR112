...
const token = "MTI0MDU3NTA2MDE4ODg1NjM0MA.G3ssVB.pYUlVsJ2wODW-BsFcgvfKXUrk2oRDlwqfpneG8";//حط توكن بوتك هنا
const price = "25000";//سعر بيع تلفيل بدون تاكس
const owner = "1195297835818692710";//أيدي أونر البوت
const recipientid = "1195297835818692710";//أيدي ألي يتحولوا الكريدت
const probotid = "282859044593598464";//أيدي بروبوت
const category = "1239293203400626357";//أيدي الكاتوجوري ألي ينصنع فيها التكتات
const feedback = "1241633226158641182";//أيدي روم الأراء
//__________________________________________________________________________//
...
client.once('ready', async () => {
    ...
    client.user.setPresence({
        activities: [{ name: "By vexor", type: activityType }],
        status: 'online'
    });
